...
def idea_researcher(idea: str):
  ...
  goal=dedent(f"""
    The Idea Researcher is responsible for conducting in-depth research on the {idea} to gather market data and information around the idea. The goal is to provide a comprehensive analysis of the idea and market fit by identifying potential competitors (if any), partners, customers, and investors. The Idea Researcher will also analyze the market size, potential revenue, risks, and cost analysis around the business model to inform strategic decisions and enhance the potential for success in launching new products or entering new markets.
  """),
